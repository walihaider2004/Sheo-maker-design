...
// import texture from './textture.json'
 ...
 console.log(loc)
  ...
  return (
    ...
    <div className="w-full lg:w-[19rem] relative">
      <div className="flex justify-center items-center h-16 bg-white fixed lg:w-[20%] w-full p-3">
      ...
      <div className="lg:overflow-y-scroll h-[500px]  scrollbar-hidden mt-16 lg:mt-0">
